...
sips --resampleWidth 120 "${DIR}/${FILE}" --out "${DIR}${iOSSubdir}/Icon-Small-40@3x.png" > /dev/null 2>&1
...
ImageOptim="/opt/homebrew-cask/Caskroom/imageoptim/latest/ImageOptim.app/Contents/MacOS/ImageOptim"
